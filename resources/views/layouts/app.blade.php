...
<head>
    ...
    <title>{{ config('app.name', 'Marinexa Shipping Pvt Ltd') }} - @yield('title')</title>
    <meta name="description" content="@yield('meta_description', 'International Logistics, Freight Forwarding, and Global Shipping (Air & Sea Cargo) services by Marinexa Shipping Pvt Ltd.')">
