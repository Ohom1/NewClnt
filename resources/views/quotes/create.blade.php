...
@section('title', 'Request a Shipping Quote')

@section('meta_description', 'Request a free, no-obligation shipping quote for your freight forwarding and logistics needs. Get competitive rates for ocean and air freight services.')
    ...
    <section class="py-16 md:py-24 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden section-animate" data-animation="animate__fadeInUp">
                ...
                <form action="{{ route('quote.store') }}" method="POST" class="p-8 lg:p-10">
                    @csrf
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                            <div>
                                ...
                                <input type="text" name="origin" id="origin" value="{{ old('origin') }}" placeholder="City, Country" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('origin') border-red-500 @enderror" required>
                                @error('origin')
                            ...
                            <div>
                                ...
                                <input type="text" name="destination" id="destination" value="{{ old('destination') }}" placeholder="City, Country" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('destination') border-red-500 @enderror" required>
                                @error('destination')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="shipping_date" id="shipping_date" value="{{ old('shipping_date') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('shipping_date') border-red-500 @enderror">
                                @error('shipping_date')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="cargo_type" id="cargo_type" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('cargo_type') border-red-500 @enderror" required>
                                    ...
                                    <option value="general" {{ old('cargo_type') == 'general' ? 'selected' : '' }}>General Cargo</option>
                                    ...
                                    <option value="oversized" {{ old('cargo_type') == 'oversized' ? 'selected' : '' }}>Oversized Cargo</option>
                                </select>
                                @error('cargo_type')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                            <div>
                                ...
                                <select name="shipping_mode" id="shipping_mode" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50">
                                    ...
                                    <option value="ocean_fcl" {{ old('shipping_mode') == 'ocean_fcl' ? 'selected' : '' }}>Ocean Freight (Full Container)</option>
                                    <option value="ocean_lcl" {{ old('shipping_mode') == 'ocean_lcl' ? 'selected' : '' }}>Ocean Freight (Less than Container)</option>
                                    <option value="air_standard" {{ old('shipping_mode') == 'air_standard' ? 'selected' : '' }}>Air Freight (Standard)</option>
                                    <option value="air_express" {{ old('shipping_mode') == 'air_express' ? 'selected' : '' }}>Air Freight (Express)</option>
                                    <option value="not_sure" {{ old('shipping_mode') == 'not_sure' ? 'selected' : '' }}>Not Sure (Need Advice)</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="container_size" id="container_size" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50">
                                    ...
                                    <option value="20ft" {{ old('container_size') == '20ft' ? 'selected' : '' }}>20ft Container</option>
                                    <option value="40ft" {{ old('container_size') == '40ft' ? 'selected' : '' }}>40ft Container</option>
                                    <option value="40ft_hc" {{ old('container_size') == '40ft_hc' ? 'selected' : '' }}>40ft High Cube</option>
                                    <option value="lcl" {{ old('container_size') == 'lcl' ? 'selected' : '' }}>LCL (Shared Container)</option>
                                    <option value="not_applicable" {{ old('container_size') == 'not_applicable' ? 'selected' : '' }}>Not Applicable</option>
                                </select>
                            </div>
                            
                            <div>
                                <label for="weight" class="block text-sm font-medium text-gray-700 mb-1">Total Weight</label>
                                <input type="text" name="weight" id="weight" value="{{ old('weight') }}" placeholder="e.g. 500 kg" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50">
                            </div>
                            
                            <div>
                                <label for="dimensions" class="block text-sm font-medium text-gray-700 mb-1">Dimensions</label>
                                <input type="text" name="dimensions" id="dimensions" value="{{ old('dimensions') }}" placeholder="e.g. 2x3x4 meters" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50">
                            </div>
                        </div>
                        
                        <div class="mt-6">
                            <label for="message" class="block text-sm font-medium text-gray-700 mb-1">Additional Information</label>
                            <textarea name="message" id="message" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50" placeholder="Please provide any additional details about your shipment requirements">{{ old('message') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('name') border-red-500 @enderror" required>
                                @error('name')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="company" id="company" value="{{ old('company') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50">
                            </div>
                            
                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Email Address <span class="text-red-500">*</span></label>
                                <input type="email" name="email" id="email" value="{{ old('email') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('email') border-red-500 @enderror" required>
                                @error('email')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="tel" name="phone" id="phone" value="{{ old('phone') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('phone') border-red-500 @enderror" required>
                                @error('phone')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="bg-gray-50 p-6 rounded-xl border border-gray-100 mb-8">
                        <div class="flex items-start">
                            <div class="flex items-center h-5 mt-1">
                                <input id="privacy_policy" name="privacy_policy" type="checkbox" class="h-5 w-5 text-secondary-green focus:ring-secondary-green border-gray-300 rounded shadow-sm @error('privacy_policy') border-red-500 @enderror" required>
                            </div>
                            <div class="ml-3">
    ...
    <section class="py-16 md:py-24 bg-background-light-grey relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mt-16 text-center section-animate" data-animation="animate__fadeInUp animate__delay-3s">
                <a href="{{ route('about') }}" class="inline-flex items-center justify-center border-2 border-primary-blue hover:bg-primary-blue hover:text-white text-primary-blue px-6 py-3 rounded-md font-semibold transition-all">
    ...
    <section class="py-16 md:py-24 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mt-10 section-animate" data-animation="animate__fadeInUp animate__delay-2s">
                <a href="{{ route('contact') }}" class="inline-flex items-center text-primary-blue hover:text-secondary-green transition-colors">
