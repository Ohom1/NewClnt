...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-primary-blue">Create New Lead</h1>
    </div>
        ...
        <form action="{{ route('admin.leads.store') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="company" id="company" value="{{ old('company') }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('company') border-red-500 @enderror">
                            @error('company')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="shipping_mode" id="shipping_mode" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('shipping_mode') border-red-500 @enderror">
                            ...
                            <option value="ocean_fcl" {{ old('shipping_mode') == 'ocean_fcl' ? 'selected' : '' }}>Ocean Freight (FCL)</option>
                            <option value="ocean_lcl" {{ old('shipping_mode') == 'ocean_lcl' ? 'selected' : '' }}>Ocean Freight (LCL)</option>
                            ...
                            <option value="multimodal" {{ old('shipping_mode') == 'multimodal' ? 'selected' : '' }}>Multimodal</option>
                        </select>
                        @error('shipping_mode')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" name="weight" id="weight" value="{{ old('weight') }}" placeholder="e.g. 500 kg" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('weight') border-red-500 @enderror">
                        @error('weight')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="dimensions" id="dimensions" value="{{ old('dimensions') }}" placeholder="e.g. 2x3x4 meters" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('dimensions') border-red-500 @enderror">
                        @error('dimensions')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="border-t border-gray-200 pt-6">
                <div class="mb-4">
                    ...
                    <textarea name="message" id="message" rows="4" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-secondary-green focus:ring focus:ring-secondary-green focus:ring-opacity-50 @error('message') border-red-500 @enderror">{{ old('message') }}</textarea>
                    @error('message')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('admin.leads.index') }}" class="btn-secondary">Cancel</a>
                    <button type="submit" class="btn-primary bg-primary-blue">Create Lead</button>
                </div>
            </div>
        </form>
    </div>
