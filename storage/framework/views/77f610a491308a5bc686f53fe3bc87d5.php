...
<?php $__env->startSection('content'); ?>
    ...
    <section class="relative">
        <div class="h-[300px] md:h-[400px] overflow-hidden">
            <img src="<?php echo e(asset($service['banner'])); ?>" alt="<?php echo e($service['title']); ?>" class="w-full h-full object-cover">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div class="text-center text-white">
                    <div class="mb-4 flex justify-center">
                        <i data-lucide="<?php echo e($service['icon']); ?>" class="w-16 h-16"></i>
                    </div>
                    <h1 class="text-4xl md:text-5xl font-bold mb-4"><?php echo e($service['title']); ?></h1>
                    <p class="text-xl max-w-3xl mx-auto"><?php echo e($service['description']); ?></p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-card shadow-sm">
                    ...
                    <a href="<?php echo e(route('services.show', 'customs-clearance')); ?>" class="text-secondary-green hover:text-primary-blue font-semibold flex items-center">
                        Learn More
                ...
                <div class="bg-white p-6 rounded-card shadow-sm">
                    ...
                    <a href="<?php echo e(route('services.index')); ?>" class="text-secondary-green hover:text-primary-blue font-semibold flex items-center">
                        Learn More
                        <i data-lucide="arrow-right" class="w-4 h-4 ml-1"></i>
                    </a>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center">
                <div class="mb-6 md:mb-0">
                    ...
                    <p class="mt-2 text-lg">Get in touch with our team to discuss your specific <?php echo e(strtolower($service['title'])); ?> requirements.</p>
                </div>
                <div class="flex space-x-4">
                    <a href="<?php echo e(route('quote.create')); ?>" class="btn-primary bg-secondary-green hover:bg-opacity-90">Request a Quote</a>
                    <a href="<?php echo e(route('contact')); ?>" class="btn-secondary border-white text-white hover:bg-white hover:text-primary-blue">Contact Us</a>
                </div>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/omdubey/Documents/marinexa-shipping-website-main/resources/views/services/show.blade.php ENDPATH**/ ?>